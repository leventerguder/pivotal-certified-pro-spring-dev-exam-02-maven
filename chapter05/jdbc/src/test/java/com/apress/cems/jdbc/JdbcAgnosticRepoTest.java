...
import com.apress.cems.jdbc.config.TestDbConfig2;
import com.apress.cems.jdbc.repos.AgnosticRepo;
 ...
 * @since 1.0
 */
@SpringJUnitConfig(classes = {TestDbConfig2.class, JdbcConfig.class})
